...
openssl req -new -key swarmserver-key.pem -out swarmserver.csr -subj "/CN=kube-swarmserver" -config openssl.cnf
...
#docker --tlsverify --tlscacert=ca.pem --tlscert=client1.pem --tlskey=client1.pem -H=$1:2376 version
#
# mkdir -pv ~/.docker
